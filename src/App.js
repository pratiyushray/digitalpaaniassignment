...
import Temperature from "../src/Components/Temprature";
...
function App() {
  ...
  useEffect(() => {
    const apiUrl = `https://api.weatherapi.com/v1/current.json?key=0352f07402fa4706afb95609242504&q=${city}&aqi=no
    `;
